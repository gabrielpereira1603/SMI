...
class TableHistoricoReclamacoes
{
    ...
    public function __construct(BuscarReclamacaoPorUsuarioDAO $buscarReclamacaoPorUsuarioDAO, BuscarComponentePorReclamacaoDAO $buscarComponentePorReclamacaoDAO)
    {
    ...
    public function getTableHistoricoReclamacao(Request $request): string
    {
        ...
        foreach ($obReclamacao as $reclamacao) {
            ...
            $content .= View::render('aluno/modules/historicoReclamacao/itensTable', [
                'codreclamacao' => $reclamacao->getCodreclamacao(),
